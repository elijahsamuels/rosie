...
export const tricksData = [
  ...
  },
  {
    ...
    howTo:
      "Simply say 'sit' and guide Rosie into a sitting position using a treat or gentle pressure on her back end.",
    category: "Basic",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Extend your hand toward Rosie's paw and say 'shake' or 'paw.' Reward her when she raises her paw to touch your hand.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Ask Rosie to 'stay' while holding your hand up in a stop gesture. Start with short durations and gradually increase the time as she learns.",
    category: "Basic",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Say 'speak' and wait for Rosie to bark. Reward her immediately to reinforce the behavior.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Encourage Rosie to lie down and then gently press her chin to the floor. Reward her for staying in this position.",
    category: "Basic",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Ask Rosie to lie down, then hold a treat near her nose and guide her in a circular motion, encouraging her to roll onto her back.",
    category: "Circus",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Hold a treat near Rosie's nose and guide her in a circular motion, encouraging her to spin around. Reward her for completing the spin.",
    category: "Circus",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Hide a treat in the room and say 'find it' while encouraging Rosie to use her nose to locate the treat. Reward her when she finds it.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Stand with your legs together and encourage Rosie to walk around you in a circle. Reward her for completing the circle.",
    category: "Circus",
    likes: 0,
  },
  {
    ...
    howTo:
      "Spread your legs apart and encourage Rosie to walk between them. Reward her for passing through.",
    category: "Circus",
    likes: 0,
  },
  {
    ...
    howTo:
      "Take slow, deliberate steps forward, encouraging Rosie to weave between your legs as you move. Reward her for completing the pattern.",
    category: "Circus",
    likes: 0,
  },
  {
    ...
    howTo:
      "Point to a toy and say 'put your toy away,' then indicate where you want Rosie to place it. Reward her when she does so.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Encourage Rosie to lay on her side and reward her for staying in this position.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Encourage Rosie to sit pretty and wave her paws in the air. Reward her for completing the action.",
    category: "Circus",
    likes: 0,
  },
  {
  ...
  },
  {
    ...
    howTo:
      "Encourage Rosie to come to your right side and sit down. Reward her for following the command.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Sit at the edge of a couch or chair and encourage Rosie to crawl under your legs. Reward her for staying in that position.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    instagramURL: "",
    description:
      "Rosie puts her paws on your arm and rests her head underneath, resembling prayer.",
    howTo:
      "Kneel down in front of Rosie and hold your arm out, encouraging her to put her paws on it and rest her head. Reward her for completing the action.",
    category: "Basic",
    likes: 0,
  },
  {
    ...
    howTo:
      "Point to where you want Rosie to go and say 'place,' then reward her for going there.",
    category: "Basic",
    likes: 0,
  },
  {
